...
[LimX SDK](https://github.com/limxdynamics/humanoid-mujoco-sim)
...
python deploy/sim2sim/gamepad_policy_controller.py   --policy limx_hu_d04_01_flat_velocity/2026-04-03_11-35-05_flat-004/exported/policy.pt   --mimic-policy limx_hu_d04_01_flat_beyondmimic/2026-04-26_17-40-05_walk1_subject1/exported/policy.pt   --mimic-motion-file motions/hu_d04_walk1_subject1_beyondmimic/motion.npz
```
...
```bash
python scripts/rsl_rl/train.py   --task=LimX-HU-D04-01-Flat-BeyondMimic-No-State-Estimation   --motion_file motions/hu_d04_walk1_subject1_beyondmimic/motion.npz   --headless   --logger tensorboard   --run_name oli_walk1_subject1
```


**Evaluate**
```bash
python scripts/rsl_rl/play.py   --task=LimX-HU-D04-01-Flat-BeyondMimic-No-State-Estimation   --num_envs=1   --checkpoint logs/rsl_rl/limx_hu_d04_01_flat_beyondmimic/2026-04-26_17-40-05_walk1_subject1/model_11500.pt  --motion_file motions/hu_d04_walk1_subject1_beyondmimic/motion.npz
```
...
python deploy/sim2real/main.py 10.192.1.2
```
The following animation shows the learned mimic policy in reality

![mimic_reality](docs/mimic_reality.gif)
