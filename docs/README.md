...
```bash
 python scripts/csv_to_npz.py   --robot oli   --input_file GMR/outputs/hu_d04_walk1_subject1_beyondmimic.csv   --input_fps 30   --output_name hu_d04_walk1_subject1_beyondmimic   --headless
...
**Evaluate**
```bash
python scripts/rsl_rl/play.py --task=LimX-HU-D04-01-Flat-BeyondMimic-No-State-Estimation --num_envs= --wandb_path=1155249297-the-chinese-university-of-hong-kong/test_tmp/v5xnw1aa
# use local mode
